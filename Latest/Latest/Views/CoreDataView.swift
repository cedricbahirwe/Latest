...
struct CoreDataView: View {
    ...
    @FetchRequest(
        sortDescriptors: [NSSortDescriptor(keyPath: \SingleNews.timestamp, ascending: true)],
        animation: .default)
    private var items: FetchedResults<SingleNews>
    ...
    private func addItem() {
        withAnimation {
            let newItem = SingleNews(context: viewContext)
